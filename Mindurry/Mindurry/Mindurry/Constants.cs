...
namespace Mindurry
{
    public static class Constants
    {
        ...
        public static readonly string PolicySignUpSignIn = "B2C_1_signinSignup"; // Policy name from AD B2C
        ...
        public static readonly string URLScheme = "callback"; // Custom Redirect URI from AD B2C (without ://auth/)
