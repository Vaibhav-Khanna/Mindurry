...
namespace Mindurry.ViewModels
{
    public class MasterPageModel : BasePageModel
    {
        ...
        public override void Init(object initData)
        {
            ...
            Items.Add(new MasterMenuItem() { Title = "Ngc", TagetType = typeof(Pages.NgcPage), Icon = "\uE724" });
            Items.Add(new MasterMenuItem() { Title = "Tableau de bord", TagetType = typeof(Pages.DashboardPage), Icon = "\uF0E2" });
